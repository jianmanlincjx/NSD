...
# 路径到你的检查点文件
checkpoint_path = '/data1/JM/BrushNet/runs/logs/brushnet_segmentationmask/checkpoint-800000/pytorch_model.bin'

# 定义要提取的键
keys_to_extract = {'linproject', 'adapter_modules'}

# 定义输出目录
output_dir = '/data1/JM/BrushNet/runs/logs/brushnet_segmentationmask/checkpoint-800000/extracted_parameters'
