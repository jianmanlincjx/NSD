...
def log_validation(
    ...
    for validation_prompt, validation_image, validation_mask in zip(validation_prompts, validation_images, validation_masks):
        ...
        new_size = (validation_image.size[0] // 4, validation_image.size[1] // 4)
        validation_image = validation_image.resize(new_size)
        validation_mask = validation_mask.resize(new_size)
        images = []
